<?php
    ...
    try {
    	...
    	foreach($result as $row) {
    		...
    		$subArray[] = "<div class='btn-group'><button type='button' id='".$row['prID']."' name='btnSelect' class='btn btn-outline-info'><span class='oi oi-pencil'></span></button><button type='button' id='".$row['prID']."' name='btnDelete' class='btn btn-outline-danger'><span class='oi oi-trash'></span></button></div>";
    		$data[] = $subArray;
    	}
		$output = array(
