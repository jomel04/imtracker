<?php
    ...
    if(!empty($_POST["search"]["value"])) {
        $query .= " AND users.lastName LIKE '%".$_POST['search']['value']."%' OR users.firstName LIKE '%".$_POST['search']['value']."%' OR expense_account.type LIKE '%".$_POST['search']['value']."%' OR section.type LIKE '%".$_POST['search']['value']."%' OR jsr.cost LIKE '%".$_POST['search']['value']."%' OR cctl.receivedBy LIKE '%".$_POST['search']['value']."%' OR cctl.status LIKE '%".$_POST['search']['value']."%'";
    }
