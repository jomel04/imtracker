...
?>
    ...
    <body>
        <?php
            ...
            require '../include/Modals/RequestForPayment/main.php';
            require '../include/Modals/RequestForPayment/cctl.php';
            require '../include/Modals/RequestForPayment/budget.php';
            require '../include/Modals/RequestForPayment/accounting.php';
        ?>
            <!-- Nav tabs -->
                            ...
                            <thead>
                                <tr class="text-white text-center">
                                    <th colspan="12" style="background-color: #3AAFA9;border-left: 2px solid #3AAFA9;border-right: 2px solid #3AAFA9">
                                        <h3>Innovations Management Request for Payment Tracker</h3>
                                    </th>
